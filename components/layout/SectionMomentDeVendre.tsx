  ...
  return (
    <section className="w-full mb-8 ">
      <div className="bg-orange-50 rounded-2xl p-8 flex flex-col sm:flex-row items-center justify-between gap-6">
        ...
        <button className="px-8 py-3 bg-primary text-white rounded-lg font-semibold hover:bg-secondary transition-colors shadow-sm flex items-center gap-2 whitespace-nowrap">
