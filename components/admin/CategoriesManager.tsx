            ...
            <div key={category.id}>
                ...
                >
                    ...
                    <div className="flex flex-col sm:flex-row items-end sm:items-center gap-2 sm:gap-4 flex-shrink-0">
                        {/* Ads Count */}
                        <div className="flex items-center gap-1 px-2 py-1 bg-white/5 rounded-full text-white/60 text-xs sm:text-sm">
                            <ShoppingBag size={14} className="opacity-70" />
                            <span>{category._count?.ads ?? 0}</span>
                        </div>
                        ...
                        <div className="flex items-center gap-1">
                            <Link
                                ...
                                className="p-1.5 text-white/60 hover:bg-white/10 rounded-lg transition-colors"
                                title="Voir détails"
                            >
                                <Eye size={18} />
                            </Link>
