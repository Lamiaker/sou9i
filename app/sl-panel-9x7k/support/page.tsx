...
const TABS = [
    { name: 'Nouveaux', href: '/sl-panel-9x7k/support', status: 'OPEN', icon: AlertCircle, color: 'from-blue-500 to-cyan-500' },
    { name: 'En cours', href: '/sl-panel-9x7k/support/in-progress', status: 'IN_PROGRESS', icon: Clock, color: 'from-yellow-500 to-orange-500' },
    { name: 'Résolus', href: '/sl-panel-9x7k/support/resolved', status: 'RESOLVED', icon: CheckCircle, color: 'from-emerald-500 to-teal-500' },
    { name: 'Fermés', href: '/sl-panel-9x7k/support/closed', status: 'CLOSED', icon: Inbox, color: 'from-gray-500 to-gray-600' },
    { name: 'Tous', href: '/sl-panel-9x7k/support/all', status: '', icon: MessageCircle, color: 'from-primary to-orange-500' },
];
                            ...
                            <div className="p-6 bg-white/5 border-b border-white/10">
                                <div className="flex items-center gap-4">
                                    ...
                                    <div className="text-right">
                                        ...
                                        {selectedTicket.user && (
                                            <a
                                                href={`/sl-panel-9x7k/users?search=${selectedTicket.user.email}`}
