        ...
        return (
            <div className="flex flex-col items-center justify-center min-h-[400px] gap-4 p-8 bg-red-500/10 border border-red-500/20 rounded-2xl mx-4">
                ...
                <div className="text-center">
                    <h2 className="text-xl font-bold text-white mb-2">Une erreur est survenue lors du chargement des données</h2>
                    <p className="text-white/60 mb-4">{getErrorMessage(statsError || dashboardError)}</p>
                    <button
    ...
    if (isLoading) {
        return (
            <div className="flex flex-col items-center justify-center min-h-[400px] gap-4">
                ...
                <p className="text-white/40 animate-pulse text-sm">Chargement des données du tableau de bord...</p>
            </div>
        );
    }
        ...
        <div className="space-y-8">
                ...
                <div className="rounded-2xl bg-white/5 backdrop-blur-xl border border-white/10 overflow-hidden">
                    <div className="p-6 border-b border-white/10">
                        <div className="flex items-center justify-between">
                            ...
                            <Link href="/sl-panel-9x7k/users" className="text-sm text-cyan-400 hover:text-cyan-300 transition-colors">
                                Voir tout
                            </Link>
                        </div>
                    </div>
                ...
                <div className="rounded-2xl bg-white/5 backdrop-blur-xl border border-white/10 overflow-hidden">
                    <div className="p-6 border-b border-white/10">
                        <div className="flex items-center justify-between">
                            ...
                            <Link href="/sl-panel-9x7k/ads" className="text-sm text-cyan-400 hover:text-cyan-300 transition-colors">
                                Voir tout
                            </Link>
                        </div>
                    </div>
                ...
                <div className="rounded-2xl bg-white/5 backdrop-blur-xl border border-white/10 overflow-hidden">
                    <div className="p-6 border-b border-white/10">
                        <div className="flex items-center justify-between">
                            ...
                            <Link href="/sl-panel-9x7k/reports" className="text-sm text-cyan-400 hover:text-cyan-300 transition-colors">
                                Voir tout
                            </Link>
                        </div>
                    </div>
            ...
            <div className="rounded-2xl bg-white/5 backdrop-blur-xl border border-white/10 p-6">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-6 gap-4">
                    <Link href="/sl-panel-9x7k/users?status=PENDING" className="flex flex-col items-center gap-2 p-4 rounded-xl bg-white/5 hover:bg-white/10 border border-white/10 transition-all duration-200 hover:scale-[1.02]">
                    ...
                    <Link href="/sl-panel-9x7k/ads?moderationStatus=PENDING" className="flex flex-col items-center gap-2 p-4 rounded-xl bg-white/5 hover:bg-white/10 border border-white/10 transition-all duration-200 hover:scale-[1.02]">
                    ...
                    <Link href="/sl-panel-9x7k/reports" className="flex flex-col items-center gap-2 p-4 rounded-xl bg-white/5 hover:bg-white/10 border border-white/10 transition-all duration-200 hover:scale-[1.02]">
                    ...
                    <Link href="/sl-panel-9x7k/support" className="flex flex-col items-center gap-2 p-4 rounded-xl bg-white/5 hover:bg-white/10 border border-white/10 transition-all duration-200 hover:scale-[1.02]">
                    ...
                    <Link href="/sl-panel-9x7k/categories" className="flex flex-col items-center gap-2 p-4 rounded-xl bg-white/5 hover:bg-white/10 border border-white/10 transition-all duration-200 hover:scale-[1.02]">
                        <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-cyan-500 to-teal-500 flex items-center justify-center">
                            <Package className="w-6 h-6 text-white" />
                        </div>
                        <span className="text-white/80 text-sm font-medium text-center">Catégories</span>
                    </Link>
                    <Link href="/sl-panel-9x7k/users?status=BANNED" className="flex flex-col items-center gap-2 p-4 rounded-xl bg-white/5 hover:bg-white/10 border border-white/10 transition-all duration-200 hover:scale-[1.02]">
