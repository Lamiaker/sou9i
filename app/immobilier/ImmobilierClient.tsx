...
// Logique de filtrage extraite pour la stabilité (performance)
const filterLogic = (annonce: ImmobilierItem, filters: ImmobilierFilters) => {
    // Search logic
    if (filters.search) {
...
export default function ImmobilierClient() {
    ...
    const initialFilters: ImmobilierFilters = {
        search: '',
        typeTransaction: '',
        typeBien: '',
        ville: '',
    ...
    const { filters, updateFilter, resetFilters, filteredData: filteredAnnonces } = useFilter<ImmobilierItem, ImmobilierFilters>(
        immobilierExamples,
        initialFilters,
        filterLogic
    );

    const filterConfigs: FilterConfig<ImmobilierFilters>[] = [
                            ...
                            <div className="flex flex-col md:flex-row">
                                ...
                                <div className="relative md:w-72 h-48 md:h-auto flex-shrink-0">
                                    ...
                                    <button
                                        ...
                                        aria-label={favorites.includes(annonce.id) ? "Retirer des favoris" : "Ajouter aux favoris"}
                                    >
                                        <Heart
